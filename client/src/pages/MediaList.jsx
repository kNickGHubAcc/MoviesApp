...
//Ανακτά και εμφανίζει μια λίστα ταινιών-σειρών από το API
const MediaList = () => {
  ...
  useEffect(() => {
    dispatch(setAppState(mediaType));     //Ανάκτηση του τύπου της ταινίας-σειράς και χρήση της setAppState με σκοπό την ενημέρωση της app state
    window.scrollTo(0, 0);
  }, [mediaType, dispatch]);
  ...
  //Χρησιμοποιείται για την αλλαγή της τρέχουσας κατηγορίας των ταινιών-σειρών
  ...
  //Καλείται μόλις ο χρήστης κλικάρει το 'Load more' με σκοπό την φόρτωση περισσοτέρων ταινιών-σειρών

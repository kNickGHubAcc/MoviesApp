...
//Ενημερωση του password ενός χρήστη
const PasswordUpdate = () => {
  const [onRequest, setOnRequest] = useState(false);
  const navigate = useNavigate();
  const dispatch = useDispatch();

  const form = useFormik({       //Χρήση του hook useFormik με σκοπό την δημιουργία φόρμας
    initialValues: {password: "", newPassword: "", confirmNewPassword: ""},       //Αρχικές τιμές των πεδίων της φόρμας
    validationSchema: Yup.object({       //Ορίζονται οι κανόνες επικύρωσης με χρήση της βιβλιοθήκης Yup
      password: Yup.string()
  ...
  //Εκτελεί το request ενημέρωσης του password, όταν υποβληθεί η φόρμα

...
const AuthModal = () => {
  ...
  const handleClose = () => dispatch(setAuthModalOpen(false));    //Κλείνει το modal

  
  const switchAuthState = (state) => setAction(state);      //Αλλάζει την τιμή της action με βάση την επιλεγμένη ενέργεια (σύνδεση ή εγγραφή)

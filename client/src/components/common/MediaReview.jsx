...
//Εμφανίζει τις πληροφορίες του χρήστη που έκανε την κριτική, την ημερομηνία και το περιεχόμενο της κριτικής.
//Επίσης, παρέχει τη δυνατότητα διαγραφής της κριτικής, αλλά μόνο από τον ίδιο χρήστη που την δημιούργησε
...
const MediaReview = ({ reviews, media, mediaType }) => {
  ...
  //Καλείται όταν ο χρήστης 'γράφει' μια νέα κριτική
  ...
  //Καλειται όταν ο χρήστης ζητά τη φόρτωση περισσοτέρων κριτικών
  const onLoadMore = () => {
    setFilteredReviews([...filteredReviews, ...[...listReviews].splice(page * skip, skip)]);
    setPage(page + 1);
  };

  //Καλείται όταν ο χρήστης διαγράφει μια κριτική
  const onRemoved = (id) => {

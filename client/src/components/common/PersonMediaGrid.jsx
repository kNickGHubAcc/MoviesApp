...
const PersonMediaGrid = ({ personId }) => {
  ...
  useEffect(() => {
    const getMedias = async () => {
      ...
      if (response) {
        const mediasSorted = response.cast.sort((a, b) => getReleaseDate(b) - getReleaseDate(a));    //Ταξινόμηση των μέσων με βάση την ημερομηνία κυκλοφορίας τους
  ...
  //Επιστρέφει την ημερομηνία κυκλοφορίας μιας ταινίας-σειράς
